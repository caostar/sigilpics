...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Tokens / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('tokens.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('plataform')) has-error @endif">
                    ...
                    <input type="text" id="plataform-field" name="plataform" class="form-control" value="{{ old("plataform") }}"/>
                    ...
                    <textarea class="form-control" id="token-field" rows="3" name="token">{{ old("token") }}</textarea>
                       @if($errors->has("token"))
